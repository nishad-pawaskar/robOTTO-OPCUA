...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean newconnectiondata(String serverName, String serverUri, Boolean security, String securityPolicies){
        ...
        long ncresult =db.insert(OPCRobottoContract.Connections.CONNECTIONS_TABLE, null, cv);
        if(ncresult == -1)
            return false;
        else
            return true;
